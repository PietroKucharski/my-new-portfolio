  ...
  return (
    <section id="contato" className="relative overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(0,255,135,.10), transparent 60%)",
        }}
      />
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-28 md:py-40">
        ...
        <Reveal delay={160}>
          <p className="mt-7 text-dim text-lg leading-relaxed">
            Aberto a oportunidades como Desenvolvedor Full Stack. Me chame para
            conversar sobre projetos, vagas ou colaborações.
          </p>
        </Reveal>
